...
type TotalSalesProps = {
  employeesTotal: number; // Employee's earnings
  companyTotal: number; // Company's earnings
};
...
/**
 * TotalSales component displays total earnings for employees and the company.
 */
